...
## Tracking a repo monthly

Leave your email on a scorecard and DevPerform sends you that repo's fresh
scorecard about once a month, with deltas against the previous one ("cycle
time: 9.2h, was 12.0h"). One email a month, nothing else, and every email
carries a one-click unsubscribe link. Re-running the benchmark with your email
after unsubscribing re-subscribes you (a fresh submit is fresh consent).
