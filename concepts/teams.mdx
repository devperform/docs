...
The analytics dashboards (Team Dashboard, Executive, DORA, Trends, Cost Capitalization) unlock once at least one engineer is assigned to a team. Until then they render blurred with a prompt to finish assignment. Seats are billed on assigned engineers only — the first 5 are free — so unassigned imports never cost anything, but they also don't unlock the product.
